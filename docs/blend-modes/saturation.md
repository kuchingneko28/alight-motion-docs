---
title: Saturation
description: "Saturation blending mode — Color category. Takes the saturation of the top layer and the hue + luminance of the bottom layer."
---

# Saturation <Badge type="info" text="Color" />
