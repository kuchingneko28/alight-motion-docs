---
title: Lighten
description: "Lighten blending mode — Lighten category. Keeps the lighter of the two color channels (R, G, B independently)."
---

# Lighten <Badge type="info" text="Lighten" />
