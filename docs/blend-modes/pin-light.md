---
title: Pin Light
description: "Pin Light blending mode — Contrast category. Replaces colors based on the top layer. If the top is darker than 50%, dark pixels pass through."
---

# Pin Light <Badge type="info" text="Contrast" />
