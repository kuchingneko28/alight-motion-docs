---
title: Hue
description: "Hue blending mode — Color category. Takes the hue of the top layer and the saturation + luminance of the bottom layer."
---

# Hue <Badge type="info" text="Color" />
